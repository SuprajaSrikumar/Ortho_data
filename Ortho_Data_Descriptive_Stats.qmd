...
Table 9 presents the mean proportion of fixations on each response option, calculated as the percentage of total fixations per trial.
...
Eye-tracking data from 66 participants (TD: n = 22, Dyslexia: n = 28, Compensated: n = 15) were included in the fixation analyses.
Table 10 presents the average dwell time (in seconds) for each response option type.
