...
```{r}
excluded_ids <- c("c171082", "c194017")

ortho_data_cleaned <- ortho_data %>%
  filter(!participant_id %in% excluded_ids) %>%
  select(-trial_correct, -fixated_all_four)
...
write_csv(ortho_data_cleaned, "2025_04_10_Ortho_data_final.csv")
```
